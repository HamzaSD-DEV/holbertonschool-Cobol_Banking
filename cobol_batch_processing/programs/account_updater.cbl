       ...
       01  WS-UPDATED-BALANCE      PIC ZZZZZZZ.99.
       ...
       WRITE-ACCOUNTS-BACK-TO-FILE.
           ...
           PERFORM VARYING WS-I FROM 1 BY 1 UNTIL WS-I > WS-ACCT-COUNT
               MOVE WS-ACCT-BALANCE(WS-I) TO WS-UPDATED-BALANCE
               STRING FUNCTION TRIM (WS-ACCT-ID(WS-I))
                      ',' DELIMITED BY SIZE
                      FUNCTION TRIM (WS-ACCT-NAME(WS-I))
                      ',' DELIMITED BY SIZE
                      FUNCTION TRIM (WS-ACCT-TYPE(WS-I))
                      ',' DELIMITED BY SIZE
                      FUNCTION TRIM (WS-UPDATED-BALANCE) 
                      DELIMITED BY SIZE
